...
<html>
   ...
   <body onload="setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
      ...
      <div style="text-align: center"><div class = "image-container-new">
<!--      <div class= "container-fluid text-center liveimage">--!>
         <div style="display: inline-block"><img id="mjpeg_dest" <?php echo getLoadClass() . getImgWidth();?> <?php if(file_exists("pipan_on")) echo "ontouchstart=\"pipan_start()\""; ?> onclick="toggle_fullscreen(this);" src="./loading.jpg"> <img id="overlay_light_button" class="overlay-button-new" src="light.png" ></div>  </div>
            <div id="main-buttons" <?php echo $displayStyle; ?> > 
            <input id="video_button" type="button" class="btn btn-primary">
            <input id="light_button" type="button" class="btn btn-primary">            
